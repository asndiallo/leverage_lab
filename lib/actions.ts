...
// ---------------------------------------------------------------------------
// Co-ownership — invite a co-owner (e.g. a spouse) to a property, or revoke a
// pending invite. There's no automated invite email (Resend's sandbox sender
// can't reach anyone but the account owner until a custom domain is verified),
// so the inviter copies the link themselves and sends it however they like.
// ---------------------------------------------------------------------------
